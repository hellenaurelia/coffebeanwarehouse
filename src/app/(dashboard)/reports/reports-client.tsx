...
import type { DataByRange } from "./_components/types";
import { exportToPDF, formatDateID } from "./_components/utils";
...
export default function ReportsClient({ dataByRange }: { dataByRange: DataByRange }) {
