...
import { updateProductPriceAction, reconcileStockAction } from "./_data/actions";
...
export default function InventoryClient({ initial }: { initial: InventoryItem[] }) {
      ...
      <RekonsiliasiModal
        ...
        onSave={(updated, lines) => {
          ...
          if (lines && lines.length > 0) {
            reconcileStockAction(lines).catch((err) =>
              console.error("Gagal menyimpan rekonsiliasi:", err)
            );
          }
        }}
      />
