...
import { Modal, ModalHeader, Field, ErrMsg, NumericInput, INP, TA, BTN_PRIMARY } from "./shared-components";
  ...
  return (
    <Modal onClose={onClose} wide>
      ...
      >
        ...
        {/* ── Footer (type submit agar Enter berfungsi) ── */}
        <div className="border-t border-border/60 px-6 py-4 flex gap-2 justify-end">
          <Button type="button" variant="outline" className={BTN_HOVER_COKLAT} onClick={onClose}>
            Batal
          </Button>
