...
export type Supplier = {
  id: string; code: string; name: string; pic: string; region: string;
...
export const initSuppliers: Supplier[] = [
  { id:"S-001", code:"S-001", name:"Koperasi Tani Gayo",    pic:"Pak Munir",   region:"Aceh Tengah",      phone:"+6285643925109", email:"munir@gayotani.id",  beans:[{name:"Arabica",       price:95000,  type:"Arabica",  active:true},{name:"Gayo Wine",     price:180000, type:"Arabica",  active:true}],  lastDelivery:"2 hari lalu",   totalKg:1840, status:"Aktif",     address:"Jl. Raya Bebesen No.12, Aceh Tengah",       notes:"Supplier utama arabica premium. Min order 100kg." },
  { id:"S-002", code:"S-002", name:"Kintamani Highland",    pic:"Bu Wayan",    region:"Bangli, Bali",     phone:"+6285643925109", email:"wayan@kintamani.co", beans:[{name:"Arabica Honey", price:120000, type:"Arabica", active:true}],                                                          lastDelivery:"5 hari lalu",   totalKg:1240, status:"Aktif",     address:"Desa Batur, Kintamani, Bangli",             notes:"Musim panen April–Juni. Kualitas konsisten." },
  { id:"S-003", code:"S-003", name:"Toraja Coffee Hub",     pic:"Pak Reynaldi",region:"Tana Toraja",      phone:"+6285643925109", email:"rey@torajacoffee.id",beans:[{name:"Arabica Sapan", price:110000, type:"Arabica", active:true}],                                                          lastDelivery:"1 minggu lalu", totalKg:980,  status:"Aktif",     address:"Jl. Pongtiku 45, Rantepao, Tana Toraja" },
  { id:"S-004", code:"S-004", name:"Lampung Robusta Mills", pic:"Pak Hendra",  region:"Lampung Barat",    phone:"+6285643925109", email:"hendra@lrm.id",      beans:[{name:"Robusta AAA",   price:48000,  type:"Robusta",  active:true},{name:"Robusta Honey", price:52000,  type:"Robusta",  active:true}],  lastDelivery:"3 hari lalu",   totalKg:3120, status:"Aktif",     address:"Kawasan Industri Way Laga, Lampung Barat",  notes:"Lead time 3 hari kerja. Harga negotiable untuk >500kg." },
  { id:"S-005", code:"S-005", name:"Civet Farm Lampung",    pic:"Pak Jaka",    region:"Liwa, Lampung",    phone:"+6285643925109", email:"jaka@civetfarm.id",  beans:[{name:"Luwak Premium", price:850000, type:"Luwak",    active:true}],                                                            lastDelivery:"2 minggu lalu", totalKg:64,   status:"Aktif",     address:"Desa Sukaraja, Liwa, Lampung Barat",        notes:"Produksi terbatas 5–10kg/minggu." },
  { id:"S-006", code:"S-006", name:"Preanger Estate",       pic:"Bu Salma",    region:"Garut, Jawa Barat",phone:"+6285643925109", email:"salma@preanger.id",  beans:[{name:"Arabica Java",  price:105000, type:"Arabica",  active:true}],                                                          lastDelivery:"10 hari lalu",  totalKg:1520, status:"Pending",   address:"Perkebunan Cikajang, Garut",                notes:"Menunggu verifikasi dokumen BPOM." },
  { id:"S-007", code:"S-007", name:"Riau Liberica Co",      pic:"Pak Daud",    region:"Meranti, Riau",    phone:"+6285643925109", email:"daud@liberica.id",   beans:[{name:"Liberica",      price:65000,  type:"Liberica", active:true}],                                                         lastDelivery:"3 minggu lalu", totalKg:280,  status:"Non-aktif", address:"Jl. Merbau No.7, Selat Panjang, Riau" },
];
