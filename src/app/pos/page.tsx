...
const products: Product[] = [
  ...
  },
  {
    ...
    variant: "200g · Whole Bean",
    price: 124000,
    tag: "Arabica",
  },
  {
    id: "p5",
    name: "Lampung Robusta AAA",
...
export default function POSPage() {
  ...
  const commitQty = (id: string) => {
    const value = parseFloat(editingQty[id]);
